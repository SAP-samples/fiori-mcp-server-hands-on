...
1. Copy and paste the following prompt into the task input and execute the task:

    ```
    Generate a new CAP project and SAP Fiori app based on the Image
    /home/user/projects/Images/manage-travels-list-report.png
...
2. Copilot prepares an implementation plan.
...
3. When prompted to proceed with the implementation plan, confirm by typing "Yes" or "Proceed".

4. Click **Allow** when prompted to run Bash commands.
...
5. Review the files and content created by Copilot, then click **Keep** to accept them.

    <img src="./images/file-changes.png" alt="copilot" width="80%"/>

6. If Copilot reaches the maximum number of requests allowed per turn in agent mode, click **Continue** to resume the implementation.
...
8. To run the application, click the **Insert into Terminal** button when Copilot presents the watch command.
